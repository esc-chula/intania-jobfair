    ...
    .sort((a, b) => {
      ...
      if (intent === "location") {
        const aLocationMatch =
          a.officeLocation_province.toLowerCase().includes(searchTerm) ||
          a.officeLocation_district.toLowerCase().includes(searchTerm);
        const bLocationMatch =
          b.officeLocation_province.toLowerCase().includes(searchTerm) ||
      ...
      if (intent === "company") {
        const aNameMatch =
          a.companyName_th.toLowerCase().includes(searchTerm) ||
          a.companyName_en.toLowerCase().includes(searchTerm);
        const bNameMatch =
          b.companyName_th.toLowerCase().includes(searchTerm) ||
