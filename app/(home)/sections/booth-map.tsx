...
import mapDay1Image from "@/src/map_new.jpg";
...
export default function BoothMap() {
    ...
    // We only have 2 images, so strictly modulo might feel weird if we want infinite loop visually
    // but let's stick to the current logic which cycles 0 -> 1 -> 0
                    ...
                    <Dialog>
                        ...
                        <DialogContent className="sm:max-w-md">
                            ...
                            <div className="flex flex-col gap-4 py-4">
                                <Link
                                    href="https://drive.google.com/file/d/130nkj0at-9QHp80mQaXfQZtot5ZqXHJI/view"
                                    target="_blank"
